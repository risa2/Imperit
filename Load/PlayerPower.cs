...
namespace Imperit.Load
{
    ...
    public class PlayersPowers : IConvertibleToWith<State.PlayerPower[], bool>
    {
        ...
        public static PlayersPowers From(State.PlayerPower[] pp) => new PlayersPowers() { Powers = pp.Select(p => new PlayerPower() { Soldiers = p.Soldiers, Money = p.Money, Income = p.Income }) };
    }
}