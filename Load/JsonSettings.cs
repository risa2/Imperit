...
namespace Imperit.Load
{
	public class JsonSettings : IConvertibleToWith<Settings, bool>
	{
		...
		public Settings Convert(int _i, bool _b) => new Settings(DebtLimit, DefaultInstability, DefaultMoney, Interest, Color.Parse(LandColor), Color.Parse(MountainsColor), MountainsWidth, RobotNames, Color.Parse(SeaColor), SoldierTypes.Select((t, i) => t.Convert(i, false)).ToImmutableArray());
