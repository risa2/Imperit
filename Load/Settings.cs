namespace Imperit.Load
{
    public class Settings : IConvertibleToWith<State.Settings, bool>
    {
        ...
        public State.Settings Convert(int useless_i, bool useless_b) => new State.Settings(Interest, DefaultInstability, DefaultMoney, DebtLimit, SingleClient, Started, RobotNames ?? new string[0], MaxRobotCount);
